...
public class Constants {
    ...
    public static final String RESPONSE_CODE_SUCCESS = "response_code_00";
    public static final String RESPONSE_CODE_ERROR = "response_code_99";
    ...
    public static final String ENDPOINT_USER_UPDATE = "user/update";
    public static final String ENDPOINT_USER_RETRIEVE = "user/retrieve";

    public static final String ENDPOINT_USER_TRANSACTION_HISTORY = "transaction/retrieve";
